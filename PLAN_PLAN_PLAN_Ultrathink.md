...
- P1 data access: Заказы пропадали при удалении товара / bulk 404 → fixed, snapshot shop_id + soft delete.
- P1 payments/time: expires_at без TZ → в работе (UTC guard добавлен, миграция TIMESTAMPTZ планируется).
