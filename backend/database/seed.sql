...
TRUNCATE TABLE subscriptions, order_items, orders, products, shops, users, promo_activations, promo_codes, shop_subscriptions, payments, invoices RESTART IDENTITY CASCADE;
...
-- Seed Shops
-- ============================================
INSERT INTO shops (owner_id, name, description, wallet_btc, wallet_eth, wallet_usdt, is_active, registration_paid, subscription_status, created_at) VALUES
(2, 'Crypto Electronics Store', 'Premium electronics and gadgets for crypto',
 'bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh',
 '0x742d35Cc6634C0532925a3b844Bc454e4438f44e',
 'TRX9yDjHnPkX3yWnMgQxDgBFzYnYeFBPQh',
 true, true, 'active', NOW() - INTERVAL '24 days'),
(3, 'Digital Goods Hub', 'Software licenses, game keys, and digital content',
 'bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdq',
 '0x71C7656EC7ab88b098defB751B7401B5f6d8976F',
 'TMuA6YqfCeX8EhbfYEg2y7xShErXWEEBvn',
 true, true, 'active', NOW() - INTERVAL '19 days');

-- ============================================
-- Seed Products
-- ============================================
INSERT INTO products (shop_id, name, description, price, currency, stock_quantity, is_active, created_at) VALUES
...
-- Seed Orders
-- ============================================
INSERT INTO orders (buyer_id, total_price, currency, payment_hash, payment_address, status, created_at, paid_at, completed_at) VALUES
-- Completed orders
(1, 0.00950000, 'BTC', '0x1a2b3c4d5e6f7890abcdef1234567890abcdef1234567890abcdef1234567890',
 'bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh', 'delivered', NOW() - INTERVAL '12 days', NOW() - INTERVAL '12 days', NOW() - INTERVAL '11 days'),
(4, 450.00000000, 'USDT', '0x2b3c4d5e6f7890abcdef1234567890abcdef1234567890abcdef1234567890ab',
 'TMuA6YqfCeX8EhbfYEg2y7xShErXWEEBvn', 'delivered', NOW() - INTERVAL '10 days', NOW() - INTERVAL '10 days', NOW() - INTERVAL '9 days'),

-- Paid orders (awaiting completion)
(5, 1200.00000000, 'USDT', '0x3c4d5e6f7890abcdef1234567890abcdef1234567890abcdef1234567890abcd',
 'TRX9yDjHnPkX3yWnMgQxDgBFzYnYeFBPQh', 'confirmed', NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days', NULL),

-- Pending orders
(1, 0.00280000, 'BTC', NULL, NULL, 'pending', NOW() - INTERVAL '2 days', NULL, NULL),
(4, 0.03200000, 'BTC', NULL, NULL, 'pending', NOW() - INTERVAL '1 day', NULL, NULL);
